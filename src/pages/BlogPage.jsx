  ...
  return (
    <div className="App">
      ...
      <main style={{ minHeight: '60vh', padding: '2rem', maxWidth: '720px', margin: '0 auto' }}>
        <h1 style={{ fontSize: '1.5rem', marginBottom: '0.5rem', color: 'var(--color-text)' }}>Blog</h1>
        <p style={{ color: 'var(--color-text-muted)', marginBottom: '1.5rem' }}>Latest trends and news in supply chain. Posts will be added here.</p>
